...
function Cart({ product }) {
  const { cart, addToCart, removeFromCart, addToFavorites, favorites, removeFromFavorites, setCurrentProduct } =
    useStore()
  ...
  return (
    <article className={styles.cart}>
      ...
      <div className={styles.info} onClick={handleDetailsClick}>
        <button>
          <span>Подробнее</span>
          <FcViewDetails />
        </button>
